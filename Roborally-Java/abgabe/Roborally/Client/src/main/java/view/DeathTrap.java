...
/**
 *Controller class for Map Death Trap. Implementation of GUI objects by Ilinur and Rea
 *Data Bindings by Ilinur, Rea, Arda, Aigerim, Benedikt
 * @author Iinur, Arda, Aigerim, Rea, Benedikt
 **/

public class DeathTrap implements Initializable {
