...
/**
 *Controller class for Map Twister. Implementation of GUI objects by Ilinur and Rea, Data Bindings by Ilinur,Rea,
 * Arda and Aigerim
 * @author Iinur, Arda, Aigerim, Rea
 */

public class Twister implements Initializable {
        ...
        public void initialize(URL url, ResourceBundle resourceBundle) {
            try {
                ...
                currentPlayerLabel.textProperty().bind(client.getCurrentPlayer().asString());
                 ...
                 client.getCheckPointMoved().addListener(new ChangeListener<String>(){
                    @Override
                    public void changed(ObservableValue<? extends String> observableValue, String oldValue, String newValue) {
                                String id = newValue.split("_")[0] ;
                                for(Node n : gridPaneChildren){
                                        if(n.getId().startsWith("checkPoint_" + id)){
                                                n.setVisible(false);
                                        }

                                        if(n.getId().equals("checkPoint_" + newValue)){
                                                n.setVisible(true);
                                        }
                                }
