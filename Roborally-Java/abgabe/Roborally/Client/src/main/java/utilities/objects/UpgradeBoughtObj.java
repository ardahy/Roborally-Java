...
public class UpgradeBoughtObj implements ClientObjectHandler<UpgradeBoughtObj>{
    ...
    @Override
    public void action(Client client, UpgradeBoughtObj bodyObject, ClientMessageHandler messageHandler) {
