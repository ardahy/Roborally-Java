 ...
 */
public class ReceivedChatObj implements ClientObjectHandler<ReceivedChatObj> {
    ...
    @Override
    public void action(Client client, ReceivedChatObj bodyObject, ClientMessageHandler messageHandler) {
