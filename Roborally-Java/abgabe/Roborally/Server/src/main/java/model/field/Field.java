...
public abstract class Field {
    ...
    private transient String isOnBoard;
    private transient ArrayList<String> orientations = new ArrayList();
    private transient ArrayList<Integer> registers = new ArrayList<>();
